...
public class WorldVer {
    ...
    public static int getBottomY(World world) {
        ...
        //#else
        //$$ return adris.rinforzando.multiversion.world.WorldHelper.getBottomY(world);
        //#endif
    }
    ...
    public static int getTopY(World world) {
        ...
        //#else
        //$$ return adris.rinforzando.multiversion.world.WorldHelper.getTopY(world);
        //#endif
    }
    ...
    private static boolean isOutOfHeightLimit(World world,BlockPos pos) {
        ...
        //#else
        //$$ return adris.rinforzando.multiversion.world.WorldHelper.isOutOfHeightLimit(world,pos);
        //#endif
    }
