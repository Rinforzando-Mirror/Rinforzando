package adris.rinforzando.multiversion.entity;
...
public class EntityVer {
    ...
    public boolean isInNetherPortal(Entity entity) {
        ...
        //#else
        return adris.rinforzando.multiversion.entity.EntityHelper.isInNetherPortal(entity);
        //#endif
    }
    ...
    public BlockPos getLandingPos(Entity entity) {
        ...
        //#else
        //$$ return ((adris.rinforzando.mixins.EntityAccessor) entity).invokeGetLandingPos();
        //#endif
    }
    ...
    private static Vec3d getEyePos(Entity entity) {
        ...
        //#else
        //$$ return adris.rinforzando.multiversion.entity.EntityHelper.getEyePos(entity);
        //#endif
    }
    ...
    private static ChunkPos getChunkPos(Entity entity) {
        ...
        //#else
        //$$ return adris.rinforzando.multiversion.entity.EntityHelper.getChunkPos(entity);
        //#endif
    }
    ...
    private static int getBlockX(Entity entity) {
        ...
        //#else
        //$$ return adris.rinforzando.multiversion.entity.EntityHelper.getBlockX(entity);
        //#endif
    }
    ...
    private static int getBlockY(Entity entity) {
        ...
        //#else
        //$$ return adris.rinforzando.multiversion.entity.EntityHelper.getBlockY(entity);
        //#endif
    }
    ...
    private static int getBlockZ(Entity entity) {
        ...
        //#else
        //$$ return adris.rinforzando.multiversion.entity.EntityHelper.getBlockZ(entity);
        //#endif
    }
