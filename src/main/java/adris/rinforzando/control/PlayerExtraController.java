...
import adris.rinforzando.eventbus.events.BlockBreakingCancelEvent;
import adris.rinforzando.eventbus.events.BlockBreakingEvent;
...
public class PlayerExtraController {
    ...
    public PlayerExtraController(Rinforzando mod) {
        this.mod = mod;
