package adris.rinforzando.control;
...
public class KillAura {
    ...
    public static void equipWeapon(Rinforzando mod) {
    ...
    public void tickEnd(Rinforzando mod) {
    ...
    private void performDelayedAttack(Rinforzando mod) {
        if (!mod.getFoodChain().needsToEat() && !mod.getMLGBucketChain().isFalling(mod) &&
                mod.getMLGBucketChain().doneMLG() && !mod.getMLGBucketChain().isChorusFruiting()) {
            if (forceHit != null) {
                attack(mod, forceHit, true);
    ...
    private void performFastestAttack(Rinforzando mod) {
        if (!mod.getFoodChain().needsToEat() && !mod.getMLGBucketChain().isFalling(mod) &&
                mod.getMLGBucketChain().doneMLG() && !mod.getMLGBucketChain().isChorusFruiting()) {
    ...
    private void attack(Rinforzando mod, Entity entity) {
        attack(mod, entity, false);
    }

    private void attack(Rinforzando mod, Entity entity, boolean equipSword) {
    ...
    public void startShielding(Rinforzando mod) {
        shielding = true;
    ...
    public void stopShielding(Rinforzando mod) {
        if (shielding) {
