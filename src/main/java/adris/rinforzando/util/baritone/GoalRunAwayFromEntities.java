package adris.rinforzando.util.baritone;
...
public abstract class GoalRunAwayFromEntities implements Goal {
    ...
    public GoalRunAwayFromEntities(Rinforzando mod, double distance, boolean xzOnly, double penaltyFactor) {
        this.mod = mod;
    ...
    protected abstract List<Entity> getEntities(Rinforzando mod);
