...
public class CraftingHelper {
     ...
     */
    public static boolean canCraftItemNow(Rinforzando mod, Item item) {
    ...
    private static boolean canCraftItemNow(Rinforzando mod, List<ItemStack> inventoryStacks, CraftingRecipe recipe, HashSet<Item> alreadyChecked) {
