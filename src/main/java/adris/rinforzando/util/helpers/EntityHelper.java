...
import adris.rinforzando.multiversion.DamageSourceWrapper;
...
public class EntityHelper {
    ...
    public static boolean isAngryAtPlayer(Rinforzando mod, Entity mob) {
    ...
    public static boolean isProbablyHostileToPlayer(Rinforzando mod, Entity entity) {
