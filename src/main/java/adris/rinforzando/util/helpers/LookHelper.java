...
public interface LookHelper {
     ...
     */
    static Vec3d getCameraPos(Rinforzando mod) {
     ...
     *
     * @param mod The Rinforzando object.
     * @return True if no collision is detected, false otherwise.
     */
    static boolean tryAvoidingInteractable(Rinforzando mod) {
     ...
     */
    private static boolean isCollidingInteractable(Rinforzando mod) {
     ...
     *
     * @param mod      The instance of the Rinforzando class.
     ...
     */
    static boolean isLookingAt(Rinforzando mod, Rotation rotation) {
     ...
     */
    static boolean isLookingAt(Rinforzando mod, BlockPos pos) {
     ...
     *
     * @param mod      The instance of Rinforzando.
     * @param rotation The desired rotation to look at.
     * @param withBaritone Whether to use Baritone to look.
     */
    static void lookAt(Rinforzando mod, Rotation rotation, boolean withBaritone) {
        if (withBaritone) {
    ...
    static void lookAt(Rotation rotation) {
        // Update the target rotation in the LookBehavior
        Rinforzando.getInstance().getClientBaritone().getLookBehavior().updateTarget(rotation, true);
     ...
     */
    static void lookAt(Rinforzando mod, Vec3d toLook, boolean withBaritone) {
     ...
     * @throws IllegalArgumentException if mod or toLook is null.
     */
    static void lookAt(Rinforzando mod, Vec3d toLook) {
        if (mod == null || toLook == null) {
            throw new IllegalArgumentException("mod and toLook cannot be null");
        }
     ...
     * @param withBaritone Whether to use Baritone to look.
     */
    static void lookAt(Rinforzando mod, BlockPos toLook, Direction side, boolean withBaritone) {
     ...
     * @param side   The direction to look from.
     */
    static void lookAt(Rinforzando mod, BlockPos toLook, Direction side) {
        // Calculate the center coordinates of the target location
        double centerX = toLook.getX() + 0.5;
        double centerY = toLook.getY() + 0.5;
        double centerZ = toLook.getZ() + 0.5;
     ...
     * @param withBaritone Whether to use Baritone to look.
     */
    static void lookAt(Rinforzando mod, BlockPos toLook, boolean withBaritone) {
     ...
     * @param toLook The block position to look at.
     */
    static void lookAt(Rinforzando mod, BlockPos toLook) {
     ...
     */
    static Rotation getLookRotation(Rinforzando mod, Vec3d toLook) {
     ...
     */
    static Rotation getLookRotation(Rinforzando mod, BlockPos toLook) {
