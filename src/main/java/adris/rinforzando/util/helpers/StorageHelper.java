package adris.rinforzando.util.helpers;

import adris.rinforzando.Rinforzando;
import adris.rinforzando.Debug;
import adris.rinforzando.TaskCatalogue;
import adris.rinforzando.mixins.AbstractFurnaceScreenHandlerAccessor;
import adris.rinforzando.multiversion.item.ItemVer;
import adris.rinforzando.multiversion.ToolMaterialVer;
...
import adris.rinforzando.util.slots.CraftingTableSlot;
import adris.rinforzando.util.slots.CursorSlot;
...
public class StorageHelper {
    ...
    private static boolean h(boolean inventoryOnly, Item... items) {
        if (inventoryOnly) {
            return Rinforzando.getInstance().getItemStorage().hasItemInventoryOnly(items);
        }
        return Rinforzando.getInstance().getItemStorage().hasItem(items);
    }
    ...
    public static Optional<Slot> getBestToolSlot(Rinforzando mod, BlockState state) {
    ...
    public static boolean shouldSaveStack(Rinforzando mod,Block block, ItemStack stack) {
    ...
    public static Optional<Slot> getGarbageSlot(Rinforzando mod) {
    ...
    public static int getNumberOfThrowawayBlocks(Rinforzando mod) {
    ...
    public static Optional<Slot> getSlotWithThrowawayBlock(Rinforzando mod) {
     ...
     */
    public static boolean itemTargetsMet(Rinforzando mod, ItemTarget... targetsToMeet) {
    ...
    public static boolean itemTargetsMetInventory(ItemTarget... targetsToMeet) {
        return Arrays.stream(targetsToMeet).allMatch(target -> Rinforzando.getInstance().getItemStorage().getItemCountInventoryOnly(target.getMatches()) >= target.getTargetCount());
    }
    ...
    public static boolean itemTargetsMetInventoryNoCursor(ItemTarget... targetsToMeet) {
        ...
        return Arrays.stream(targetsToMeet).allMatch(target -> {
            int count = Rinforzando.getInstance().getItemStorage().getItemCountInventoryOnly(target.getMatches());
    ...
    public static boolean isArmorEquipped(Item... any) {
        ClientPlayerEntity player = Rinforzando.getInstance().getPlayer();
    ...
    public static int getBuildingMaterialCount() {
        return Rinforzando.getInstance().getItemStorage().getItemCount(
                Arrays.stream(Rinforzando.getInstance().getModSettings().getThrowawayItems(true))
    ...
    public static int calculateInventoryFoodScore() {
        ItemStorageTracker itemStorage = Rinforzando.getInstance().getItemStorage();
    ...
    public static double calculateInventoryFuelCount(Rinforzando mod) {
        double result = 0;
    ...
    public static boolean hasRecipeMaterialsOrTarget(Rinforzando mod, RecipeTarget... targets) {
    ...
    public static boolean hasCataloguedItem(Rinforzando mod, String cataloguedName) {
     ...
     * are none.
     */
    public static Optional<Slot> getFilledInventorySlotInaccessibleToContainer(Rinforzando mod, ItemTarget withItem) {
    ...
    public static boolean isItemInaccessibleToContainer(Rinforzando mod, ItemTarget item) {
