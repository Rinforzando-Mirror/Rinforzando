...
import adris.rinforzando.multiversion.BlockTagVer;
...
import adris.rinforzando.util.WoodType;
...
public class ItemHelper {
    ...
    private static boolean isStackProtected(Rinforzando mod, ItemStack stack) {
    ...
    public static boolean canThrowAwayStack(Rinforzando mod, ItemStack stack) {
