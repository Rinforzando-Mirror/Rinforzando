...
public abstract class Command {
    ...
    public void run(Rinforzando mod, String line, Runnable onFinish) throws CommandException {
    ...
    protected abstract void call(Rinforzando mod, ArgParser parser) throws CommandException;
