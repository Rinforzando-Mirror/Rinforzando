...
import adris.rinforzando.util.slots.*;
...
public class ItemStorageTracker extends Tracker {
    ...
    public ItemStorageTracker(Rinforzando mod, TrackerManager manager, Consumer<ContainerSubTracker> containerTrackerConsumer) {
        super(manager);
