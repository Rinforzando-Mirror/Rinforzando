...
public class MineAndCollectTask extends ResourceTask {
    ...
    private void makeSureToolIsEquipped(Rinforzando mod) {
    ...
    public static class MineOrCollectTask extends AbstractDoToClosestObjectTask<Object> {
        ...
        @Override
        protected Vec3d getPos(Rinforzando mod, Object obj) {
        ...
        @Override
        protected Optional<Object> getClosestTo(Rinforzando mod, Vec3d pos) {
        ...
        public static Pair<Double, Optional<ItemEntity>> getClosestItemDrop(Rinforzando mod,Vec3d pos, ItemTarget... items) {
        ...
        public static Pair<Double,Optional<BlockPos> > getClosestBlock(Rinforzando mod,Vec3d pos ,Block... blocks) {
        ...
        @Override
        protected boolean isValid(Rinforzando mod, Object obj) {
            if (obj instanceof BlockPos b) {
