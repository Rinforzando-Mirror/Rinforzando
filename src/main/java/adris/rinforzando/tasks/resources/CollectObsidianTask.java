...
public class CollectObsidianTask extends ResourceTask {
    ...
    private static BlockPos getGoodObsidianPosition(Rinforzando mod) {
    ...
    @Override
    protected adris.rinforzando.tasksystem.Task onResourceTick(Rinforzando mod) {
    ...
    @Override
    protected void onResourceStop(Rinforzando mod, adris.rinforzando.tasksystem.Task interruptTask) {
