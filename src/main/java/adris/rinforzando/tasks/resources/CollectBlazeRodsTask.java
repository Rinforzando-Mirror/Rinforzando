...
public class CollectBlazeRodsTask extends ResourceTask {
    ...
    private static boolean isHoveringAboveLavaOrTooHigh(Rinforzando mod, Entity entity) {
        int MAX_HEIGHT = 11;
    ...
    private boolean isValidBlazeSpawner(Rinforzando mod, BlockPos pos) {
    ...
    protected String toDebugStringName() {
        return "Collect blaze rods - "+ Rinforzando.getInstance().getItemStorage().getItemCount(Items.BLAZE_ROD)+"/"+_count;
    }
