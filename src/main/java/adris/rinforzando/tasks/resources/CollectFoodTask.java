...
public class CollectFoodTask extends Task {
    ...
    public static double calculateFoodPotential(Rinforzando mod) {
    ...
    static void blackListChickenJockeys(Rinforzando mod) {
     ...
     */
    private Task pickupBlockTaskOrNull(Rinforzando mod, Block blockToCheck, Item itemToGrab, Predicate<BlockPos> accept, double maxRange) {
    ...
    private Task pickupBlockTaskOrNull(Rinforzando mod, Block blockToCheck, Item itemToGrab, double maxRange) {
