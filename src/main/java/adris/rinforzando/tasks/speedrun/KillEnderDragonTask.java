...
import adris.rinforzando.tasks.entity.AbstractKillEntityTask;
...
import adris.rinforzando.tasks.resources.CollectBlockByOneTask;
...
public class KillEnderDragonTask extends Task {
    ...
    private static Task getPickupTaskIfAny(Rinforzando mod, Item... itemsToPickup) {
    ...
    private BlockPos locateExitPortalTop(Rinforzando mod) {
    ...
    private class PunkEnderDragonTask extends Task {
        ...
        private void hit(Rinforzando mod) {
        ...
        private void stopHitting(Rinforzando mod) {
            if (_wasHitting) {
        ...
        @Override
        protected void onStart() {
            Rinforzando.getInstance().getClientBaritone().getCustomGoalProcess().onLostControl();
        }
        ...
        private BlockPos getRandomWanderPos(Rinforzando mod) {
