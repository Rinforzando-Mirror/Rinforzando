...
import adris.rinforzando.tasks.speedrun.beatgame.prioritytask.prioritycalculators.DistancePriorityCalculator;
...
public class MineBlockPriorityTask extends PriorityTask{
    ...
    public MineBlockPriorityTask(Block[] toMine, Item[] droppedItem, MiningRequirement miningRequirement, DistancePriorityCalculator prioritySupplier, Function<Rinforzando, Boolean> canCall) {
    ...
    public MineBlockPriorityTask(Block[] toMine, Item[] droppedItem, MiningRequirement miningRequirement, DistancePriorityCalculator prioritySupplier, Function<Rinforzando, Boolean> canCall, boolean shouldForce, boolean canCache, boolean bypassForceCooldown) {
    ...
    private double getClosestDist(Rinforzando mod) {
