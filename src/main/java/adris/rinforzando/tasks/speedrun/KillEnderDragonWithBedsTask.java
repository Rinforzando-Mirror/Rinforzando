...
public class KillEnderDragonWithBedsTask extends Task {
    ...
    public static BlockPos locateExitPortalTop(Rinforzando mod) {
    ...
    protected void onStart() {
        ...
        Rinforzando.getInstance().getBehaviour().avoidBlockPlacing((pos) -> pos.getZ() == 0 && Math.abs(pos.getX()) < 5);
    }
    ...
    private Task performOneCycle(Rinforzando mod, EnderDragonEntity dragon) {
    ...
    protected void onStop(Task interruptTask) {
        Rinforzando.getInstance().getFoodChain().shouldStop(false);
    }
