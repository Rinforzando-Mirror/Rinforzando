...
import adris.rinforzando.tasks.resources.CollectFuelTask;
...
import adris.rinforzando.util.slots.BlastFurnaceSlot;
...
public class SmeltInBlastFurnaceTask extends ResourceTask {
    ...
    static class DoSmeltInBlastFurnaceTask extends DoStuffInContainerTask {
        ...
        @Override
        protected BlockPos overrideContainerPosition(Rinforzando mod) {
            // If we have a valid container position, KEEP it.
            return getTargetContainerPosition();
        }

        private void tryUpdateOpenBlastFurnace(Rinforzando mod) {
