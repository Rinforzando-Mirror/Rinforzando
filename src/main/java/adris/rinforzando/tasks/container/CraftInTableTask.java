...
import adris.rinforzando.tasks.CraftGenericWithRecipeBooksTask;
...
import adris.rinforzando.util.JankCraftingRecipeMapping;
...
class DoCraftInTableTask extends DoStuffInContainerTask {
    ...
    /**
     * Returns the cost to make a new Rinforzando mod.
     *
     * @param mod The Rinforzando mod instance.
     * @return The cost to make a new Rinforzando mod.
     */
    @Override
