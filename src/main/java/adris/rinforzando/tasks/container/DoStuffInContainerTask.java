...
public abstract class DoStuffInContainerTask extends Task {
    ...
    protected abstract boolean isContainerOpen(Rinforzando mod);

    protected abstract Task containerSubTask(Rinforzando mod);

    protected abstract double getCostToMakeNew(Rinforzando mod);
}
