...
public abstract class CustomBaritoneGoalTask extends Task implements ITaskRequiresGrounded {
    ...
    public boolean isFinished() {
        if (cachedGoal == null) {
            cachedGoal = newGoal(Rinforzando.getInstance());
        }
        return cachedGoal != null && cachedGoal.isInGoal(Rinforzando.getInstance().getPlayer().getBlockPos());
    }
    ...
    protected abstract Goal newGoal(Rinforzando mod);

    protected void onWander(Rinforzando mod) {
    }
}
