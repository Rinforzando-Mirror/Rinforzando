...
public class ThrowEnderPearlSimpleProjectileTask extends Task {
    ...
    private static boolean cleanThrow(Rinforzando mod, float yaw, float pitch) {
    ...
    private static Rotation calculateThrowLook(Rinforzando mod, BlockPos end) {
    ...
    public boolean isFinished() {
        return _thrown && _thrownTimer.elapsed() || (!_thrown && !Rinforzando.getInstance().getItemStorage().hasItem(Items.ENDER_PEARL));
    }
