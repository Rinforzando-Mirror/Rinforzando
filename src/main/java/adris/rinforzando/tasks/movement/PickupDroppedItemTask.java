...
import adris.rinforzando.tasks.resources.SatisfyMiningRequirementTask;
import adris.rinforzando.tasks.slot.EnsureFreeInventorySlotTask;
import adris.rinforzando.tasksystem.ITaskRequiresGrounded;
...
public class PickupDroppedItemTask extends AbstractDoToClosestObjectTask<ItemEntity> implements ITaskRequiresGrounded {
    ...
    public static boolean isIsGettingPickaxeFirst(Rinforzando mod) {
        return isGettingPickaxeFirstFlag && mod.getModSettings().shouldCollectPickaxeFirst();
    }

    private boolean isAnnoying(Rinforzando mod, BlockPos pos) {
    ...
    private BlockPos stuckInBlock(Rinforzando mod) {
    ...
    @Override
    protected Vec3d getPos(Rinforzando mod, ItemEntity obj) {
    ...
    @Override
    protected Optional<ItemEntity> getClosestTo(Rinforzando mod, Vec3d pos) {
    ...
    @Override
    protected boolean isValid(Rinforzando mod, ItemEntity obj) {
