...
public class EscapeFromLavaTask extends CustomBaritoneGoalTask {
    ...
    public EscapeFromLavaTask(Rinforzando mod) {
        this(mod, 100);
    }
    ...
    private Optional<Item> calculateFood(Rinforzando mod) {
        Item bestFood = null;
    ...
    public HitResult raycast(Rinforzando mod,double maxDistance, float pitch, float yaw) {
