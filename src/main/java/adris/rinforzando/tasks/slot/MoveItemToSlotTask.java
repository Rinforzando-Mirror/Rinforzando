...
public class MoveItemToSlotTask extends Task {
    ...
    private final Function<Rinforzando, List<Slot>> getMovableSlots;

    public MoveItemToSlotTask(ItemTarget toMove, Slot destination, Function<Rinforzando, List<Slot>> getMovableSlots) {
        this.toMove = toMove;
    ...
    private Optional<Slot> getBestSlotToPickUp(Rinforzando mod, Item[] validItems) {
        Slot bestMatch = null;
