...
public class RavageRuinedPortalsTask extends Task {
    ...
    protected Task onTick() {
        ...
        Optional<BlockPos> closest = locateClosestUnopenedRuinedPortalChest(Rinforzando.getInstance());
    ...
    private Optional<BlockPos> locateClosestUnopenedRuinedPortalChest(Rinforzando mod) {
