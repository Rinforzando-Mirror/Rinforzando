...
import adris.rinforzando.eventbus.events.GameOverlayEvent;
...
public class PlaceBedAndSetSpawnTask extends Task {
    ...
    public boolean isFinished() {
        ...
        boolean isSleeping = Rinforzando.getInstance().getPlayer().isSleeping();
     ...
     */
    private BlockPos locateBedRegion(Rinforzando mod, BlockPos origin) {
     ...
     */
    private boolean isGoodPosition(Rinforzando mod, BlockPos pos) {
     ...
     */
    private boolean isGoodToPlaceInsideOrClear(Rinforzando mod, BlockPos pos) {
     ...
     */
    private boolean isGoodAsBorder(Rinforzando mod, BlockPos pos) {
