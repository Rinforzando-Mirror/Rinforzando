...
public class ShootArrowSimpleProjectileTask extends Task {
    ...
    private static Rotation calculateThrowLook(Rinforzando mod, Entity target) {
    ...
    private static float Vec3dToYaw(Rinforzando mod, Vec3d vec) {
    ...
    protected void onStop(Task interruptTask) {
        Rinforzando.getInstance().getInputControls().release(Input.CLICK_RIGHT);
    }
