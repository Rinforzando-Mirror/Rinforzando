...
public class DoToClosestBlockTask extends AbstractDoToClosestObjectTask<BlockPos> {
    ...
    @Override
    protected Vec3d getPos(Rinforzando mod, BlockPos obj) {
        return WorldHelper.toVec3d(obj);
    }

    @Override
    protected Optional<BlockPos> getClosestTo(Rinforzando mod, Vec3d pos) {
        if (getClosest != null) {
    ...
    @Override
    protected boolean isValid(Rinforzando mod, BlockPos obj) {
