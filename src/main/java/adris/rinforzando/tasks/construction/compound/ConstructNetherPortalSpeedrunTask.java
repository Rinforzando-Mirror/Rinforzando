...
import adris.rinforzando.tasks.construction.ClearLiquidTask;
 ...
 */
public class ConstructNetherPortalSpeedrunTask extends adris.rinforzando.tasksystem.Task {
    ...
    private final adris.rinforzando.tasksystem.Task collectLavaTask = TaskCatalogue.getItemTask(Items.LAVA_BUCKET, 1);
    ...
    @Override
    protected adris.rinforzando.tasksystem.Task onTick() {
        Rinforzando mod = Rinforzando.getInstance();
    ...
    @Override
    protected boolean isEqual(adris.rinforzando.tasksystem.Task other) {
    ...
    private BlockPos findLavaLake(Rinforzando mod, BlockPos playerPos) {
    ...
    private static class LavaTarget {
        ...
        private adris.rinforzando.tasksystem.Task placeTask(BlockPos portalOrigin, boolean below) {
