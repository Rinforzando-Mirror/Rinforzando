...
public class PlaceBlockTask extends Task implements ITaskRequiresGrounded {
    ...
    public int getMaterialCount(Rinforzando mod) {
    ...
    public boolean isFinished() {
        ...
        BlockState state = Rinforzando.getInstance().getWorld().getBlockState(target);
    ...
    private class PlaceStructureSchematic extends AbstractSchematic {
        ...
        private final Rinforzando _mod;

        public PlaceStructureSchematic(Rinforzando mod) {
            super(1, 1, 1);
            _mod = mod;
        }
