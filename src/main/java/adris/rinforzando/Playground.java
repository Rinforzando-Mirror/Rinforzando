...
import adris.rinforzando.tasks.CraftGenericManuallyTask;
import adris.rinforzando.tasks.construction.PlaceBlockNearbyTask;
import adris.rinforzando.tasks.construction.PlaceStructureBlockTask;
import adris.rinforzando.tasks.construction.compound.ConstructIronGolemTask;
import adris.rinforzando.tasks.construction.compound.ConstructNetherPortalObsidianTask;
...
import adris.rinforzando.tasks.entity.ShootArrowSimpleProjectileTask;
import adris.rinforzando.tasks.examples.ExampleTask2;
import adris.rinforzando.tasks.misc.EquipArmorTask;
import adris.rinforzando.tasks.misc.PlaceBedAndSetSpawnTask;
import adris.rinforzando.tasks.misc.RavageDesertTemplesTask;
import adris.rinforzando.tasks.misc.RavageRuinedPortalsTask;
import adris.rinforzando.tasks.movement.*;
import adris.rinforzando.tasks.resources.CollectBlazeRodsTask;
import adris.rinforzando.tasks.resources.CollectFlintTask;
import adris.rinforzando.tasks.resources.CollectFoodTask;
import adris.rinforzando.tasks.resources.TradeWithPiglinsTask;
import adris.rinforzando.tasks.speedrun.KillEnderDragonTask;
import adris.rinforzando.tasks.speedrun.KillEnderDragonWithBedsTask;
import adris.rinforzando.tasks.speedrun.WaitForDragonAndPearlTask;
 ...
 * https://github.com/adrisj7-Rinforzando/altoclef/pull/7#discussion_r641792377
...
public class Playground {
    ...
    public static void IDLE_TEST_INIT_FUNCTION(Rinforzando mod) {
        // Test code here
    ...
    public static void IDLE_TEST_TICK_FUNCTION(Rinforzando mod) {
        // Test code here
    }

    public static void TEMP_TEST_FUNCTION(Rinforzando mod, String arg) {
        //mod.runUserTask();
