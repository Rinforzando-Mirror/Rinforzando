...
public class CommandStatusOverlay {
    ...
    public void render(Rinforzando mod, DrawContextWrapper context) {
    ...
    private void drawTaskChain(DrawContextWrapper context, TextRenderer renderer, int x, int y, MatrixStack matrices, int maxLines, List<Task> tasks, Rinforzando mod) {
