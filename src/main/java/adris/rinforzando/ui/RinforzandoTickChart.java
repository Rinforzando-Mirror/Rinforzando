package adris.rinforzando.ui;

import adris.rinforzando.Rinforzando;
import adris.rinforzando.multiversion.InGameHudVer;
...
/**
 * displays a chart indicating how much of the tick time is taken up by rinforzando
 * (very similar to Minecrafts `TickChart`)
 */
public class RinforzandoTickChart {


    protected final TextRenderer textRenderer;
    protected final List<Long> list = new ArrayList<>();

    public RinforzandoTickChart(TextRenderer textRenderer) {
    ...
    public void render(Rinforzando mod, DrawContextWrapper context, int x, int width) {
