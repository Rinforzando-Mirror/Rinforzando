...
import adris.rinforzando.tasks.movement.MLGBucketTask;
import adris.rinforzando.tasksystem.ITaskOverridesGrounded;
...
public class MLGBucketFallChain extends SingleTaskChain implements ITaskOverridesGrounded {
    ...
    public boolean isFalling(Rinforzando mod) {
