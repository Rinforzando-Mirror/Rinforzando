...
public class UnstuckChain extends SingleTaskChain {
    ...
    private void checkStuckOnEndPortalFrame(Rinforzando mod) {
    ...
    private void checkEatingGlitch() {
        FoodChain foodChain = Rinforzando.getInstance().getFoodChain();
    ...
    public float getPriority() {
        ...
        if (!Rinforzando.inGame() || MinecraftClient.getInstance().isPaused() || !mod.getUserTaskChain().isActive())
