...
import adris.rinforzando.Settings;
import adris.rinforzando.multiversion.FoodComponentWrapper;
...
public class FoodChain extends SingleTaskChain {
    ...
    private void startEat(Rinforzando mod, Item food) {
    ...
    private Pair<Integer, Optional<Item>> calculateFood(Rinforzando mod) {
        Item bestFood = null;
