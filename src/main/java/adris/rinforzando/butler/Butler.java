 ...
 * <p>
 * Authorization is defined in "rinforzando_butler_whitelist.txt" and "rinforzando_butler_blacklist.txt"
 * and depends on the "useButlerWhitelist" and "useButlerBlacklist" settings in "rinforzando_settings.json"
 */
public class Butler {
    ...
    private void executeWhisper(String username, String message) {
        ...
        Rinforzando.getCommandExecutor().execute(prefix + message, () -> {
            // On finish
